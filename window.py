...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/lufei.jpg"))
        # 图片读取进程
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/UI/up.jpg"))
        self.right_img.setPixmap(QPixmap("images/UI/right.jpg"))
        ...
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/up.jpg"))
        ...
        label_super.setText("<a href='https://blog.csdn.net/'>或者你可以在这里找到我-->jasmine</a>")
        ...
        self.setTabIcon(0, QIcon('images/UI/lufei.jpg'))
        self.setTabIcon(1, QIcon('images/UI/lufei.jpg'))
        self.setTabIcon(2, QIcon('images/UI/lufei.jpg'))
